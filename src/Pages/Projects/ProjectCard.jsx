    ...
    return (
        <div className="bg-white shadow-lg rounded-lg overflow-hidden">
            <div className="p-4">
              ...
              <div className="mt-4">
                <img src={project.image} alt={project.name} className="w-full h-48 object-cover rounded" />
              </div>
              <div className="mt-4 text-green-500">
                <h1>Purpose: {project.purpose}</h1>
                <h1 className="flex items-center gap-3">Budget: {project.budget} <FaMoneyBill></FaMoneyBill> </h1>
