      ...
      <footer className="bg-green-200 py-8">
        <section className="grid grid-cols-3 gap-8 container mx-auto">
          <div className="col-span-3 px-3 lg:col-span-1 flex items-center">
            <h1 className="text-3xl font-bold text-blue-900">Village Management</h1>
          </div>
          <div className="col-span-3 flex flex-col  justify-center  px-3 lg:col-span-1">
          ...
          <div className="col-span-3  px-3 flex justify-center items-center">
            <ul className="flex gap-4">
              <li>
                <Link to="#" className="text-blue-900 hover:text-blue-600 transition duration-300">
                  Terms of Service
                </Link>
              </li>
              <li>
